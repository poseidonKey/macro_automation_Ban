...
class LoginBot:
    ...
    def login(self, id, ps):
        self.driver.find_element(
            by=By.XPATH, value="/html/body/div[1]/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div/div[5]/label/div/div[2]").click()
        # 아이디를 입력합니다.
        pw.typing(id)
