...
class ImgCrawler:
    ...
    def crawl_one_image(self):
        ...
        # 이미지 요소를 가져옵니다.
        image_element = self.driver.find_element(by=By.XPATH, value=img_xpath)
        ...
        image = self.driver.find_element(by=By.TAG_NAME, value="img")
        # 이미지를 저장합니다.
    ...
    def next_image(self):
        ...
        # 버튼 요소를 가져옵시다.
        next_button = self.driver.find_element(by=By.XPATH, value=button_xpath)
